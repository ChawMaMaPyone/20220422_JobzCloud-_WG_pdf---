                               ...
                               <%-- 20220321 Add End--%>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="合計金額" SortExpression="合計金額">
                                        <ItemTemplate>
                                            <div class="grip" style="text-align: right; padding-right: 4px; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; word-break: break-all;"><%--20220422 Chaw Added--%>
                                                <asp:Label ID="lblnGokeiKingaku_Grid" runat="server" CssClass="JC07Labelcss" Text=' <%# Bind("合計金額","{0:#,##0.##}") %>' ToolTip=' <%# Bind("合計金額","{0:#,##0.##}") %>'></asp:Label> <%--20220422 Chaw Added--%>
                                            </div>
                                        </ItemTemplate>
                                        <%--<HeaderTemplate>
